...
public class Home_Schedule_model {
    ...
    public static ArrayList<Home_Schedule_model> getData()
    {
        ArrayList<Home_Schedule_model> dataList = new ArrayList<>();
        ...
        {
            Home_Schedule_model schedule_model =new Home_Schedule_model();
